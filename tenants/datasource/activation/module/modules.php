...
class numbers_tenants_tenants_datasource_activation_module_modules extends object_datasource {
	public $db_link;
	public $db_link_flag;
	...
	public $primary_model = 'numbers_backend_system_modules_model_modules';
	public $parameters = [];
	...
	public function query($parameters, $options = []) {
		...
		$this->query->join('LEFT', function (& $query) {
			...
			$query = numbers_tenants_tenants_model_modules::query_builder_static(['alias' => 'inner_a'])->select();
			$query->columns([
