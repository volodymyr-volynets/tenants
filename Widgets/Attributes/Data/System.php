...
namespace Numbers\Tenants\Widgets\Attributes\Data;
class System extends \Object\Import {
	public $data = [
		...
		'menu' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Tenants\Widgets\Attributes\Controller\Attributes',
					'sm_resource_code' => '\Menu\Numbers\Tenants\Widgets\Attributes\Controller\Attributes',
					...
					'sm_resource_acl_permission' => 1,
					'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Tenants\Widgets\Attributes\Controller\Attributes',
					'sm_resource_menu_acl_method_code' => 'index',
					'sm_resource_menu_acl_action_id' => '::id::List_View',
					'sm_resource_menu_url' => '/Numbers/Tenants/Widgets/Attributes/Controller/Attributes',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_inactive' => 0
				]
			]
