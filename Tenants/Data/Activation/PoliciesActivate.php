...
class PoliciesActivate extends Import
{
    public $data = [
        'policy_roots' => [
            'options' => [
            ...
            'data' => [
                [
                    ...
                    'tm_polroot_icon' => 'fa-solid fa-wrench',
                ...
                [
                    ...
                    'tm_polroot_icon' => 'fa-regular fa-user',
                    'tm_polroot_inactive' => 0
                ],
            ]
        ],
        'policy_folders' => [
            ...
            'data' => [
                [
                    ...
                    'tm_polfolder_icon' => 'fa-solid fa-assistive-listening-systems',
