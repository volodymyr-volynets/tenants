...
class Details extends \Object\Table {
	...
	public $pk = ['tm_assigndet_tenant_id', 'tm_assigndet_assignment_id', 'tm_assigndet_type_id', 'tm_assigndet_parent_abacattr_id', 'tm_assigndet_child_abacattr_id'];
	public $tenant = true;
	public $orderby = [
	...
	public $columns = [
		...
		'tm_assigndet_parent_abacattr_id' => ['name' => 'Parent Attribute #', 'domain' => 'attribute_id'],
		'tm_assigndet_child_abacattr_id' => ['name' => 'Child Attribute #', 'domain' => 'attribute_id'],
		'tm_assigndet_type_id' => ['name' => 'Type', 'domain' => 'type_id', 'options_model' => '\Numbers\Tenants\Tenants\Model\Assignment\Detail\Types'],
		'tm_assigndet_name' => ['name' => 'Name', 'domain' => 'name'],
		'tm_assigndet_inactive' => ['name' => 'Inactive', 'type' => 'boolean'],
	];
	public $constraints = [
		'tm_assignment_details_pk' => ['type' => 'pk', 'columns' => ['tm_assigndet_tenant_id', 'tm_assigndet_type_id', 'tm_assigndet_assignment_id', 'tm_assigndet_parent_abacattr_id', 'tm_assigndet_child_abacattr_id']],
		...
		'tm_assigndet_parent_abacattr_id_fk' => [
			'type' => 'fk',
			'columns' => ['tm_assigndet_parent_abacattr_id'],
			'foreign_model' => '\Numbers\Backend\ABAC\Model\Attributes',
			'foreign_columns' => ['sm_abacattr_id']
		],
		'tm_assigndet_child_abacattr_id_fk' => [
			'type' => 'fk',
			'columns' => ['tm_assigndet_child_abacattr_id'],
			'foreign_model' => '\Numbers\Backend\ABAC\Model\Attributes',
			'foreign_columns' => ['sm_abacattr_id']
		],
	];
