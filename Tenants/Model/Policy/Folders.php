...
use Numbers\Tenants\Tenants\Model\View\Policy\FoldersGrouppedCounter;
use Numbers\Tenants\Tenants\Model\View\Policy\PoliciesGrouppedCounter;
use Object\Table;
...
class Folders extends Table
{
    ...
    {
        $existing_folders_query = FoldersGrouppedCounter::queryBuilderStatic(['alias' => 'inner_a'])->select();
        $existing_folders_query->columns('counter');
        $existing_folders_query->where('AND', ['inner_a.tm_polfolder_id', '=', 'a.tm_polfolder_id', true]);
        $existing_policies_query = PoliciesGrouppedCounter::queryBuilderStatic(['alias' => 'inner_b'])->select();
