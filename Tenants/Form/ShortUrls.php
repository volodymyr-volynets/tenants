...
class ShortUrls extends \Object\Form\Wrapper\Base {
	...
	public function post(& $form) {
		if (empty($form->values['tm_shorturl_short_key'])) {
			$form->values['tm_shorturl_short_key'] = \Numbers\Tenants\Tenants\Helper\ShortUrls::tokenCreate($form->values['tm_shorturl_id']);
