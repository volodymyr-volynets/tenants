...
class Folders extends Base
{
    ...
    public $elements = [
        'top' => [
            'tm_polroot_code' => [
                'tm_polroot_code' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Root', 'domain' => 'type_code', 'null' => true, 'required' => true, 'percent' => 100, 'method' => 'select', 'options_model' => '\Numbers\Tenants\Tenants\Model\Policy\Roots::optionsActive', 'refetch_values_on_change' => true, 'placeholder' => Messages::PLEASE_CHOOSE, 'onchange' => 'this.form.submit();'],
            ],
        ],
        'tree_container' => [
            self::HIDDEN => [
    ...
    public function validate(& $form)
    {
        ...
        if (!$model->checkUniqueConstraint('tm_polfolder_name', $model->pk, [
            ...
            $form->error(DANGER, Messages::DUPLICATE_VALUE, 'tree_container_modal_tm_polfolder_name');
        }
    }
