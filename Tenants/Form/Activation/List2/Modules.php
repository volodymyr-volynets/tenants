    ...
    public $elements = [
        ...
        'filter' => [
            'tm_module_id' => [
                ...
                'tm_module_module_code1' => ['order' => 3, 'label_name' => 'Module Type', 'domain' => 'module_code', 'percent' => 50, 'null' => true, 'method' => 'multiselect', 'multiple_column' => 1, 'options_model' => '\Numbers\Backend\System\Modules\Model\Modules', 'query_builder' => 'a.tm_module_module_code'],
            ],
            'tm_module_module_code' => [
                ...
                'tm_module_inactive1' => ['order' => 2, 'label_name' => 'Inactive', 'type' => 'boolean', 'percent' => 50, 'method' => 'multiselect', 'multiple_column' => 1, 'options_model' => '\Object\Data\Model\Inactive', 'query_builder' => 'a.tm_module_inactive;=']
            ],
            'full_text_search' => [
