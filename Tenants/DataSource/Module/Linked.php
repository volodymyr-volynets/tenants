...
class Linked extends \Object\DataSource {
	public $db_link;
	public $db_link_flag;
	...
	public function query($parameters, $options = []) {
		...
		$this->query->union('UNION', function (& $query) {
			// first query
			$query1 = \Numbers\Tenants\Tenants\Model\Modules::queryBuilderStatic(['alias' => 'union_a'])->select();
			$query1->columns([
			...
			// second query
			$query2 = \Numbers\Tenants\Tenants\Model\Modules::queryBuilderStatic(['alias' => 'union_a'])->select();
			$query2->columns([
